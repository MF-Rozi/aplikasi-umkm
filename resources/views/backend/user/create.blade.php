                    ...
                    <form method="POST" name="userCreate" action="{{ route('admin.user.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror" type="text" name="email"
                                id="email" placeholder="Enter Your Email Adress" value="{{ old('email') }}">
                            @error('email')
                        ...
                        <div class="form-group">
                            <label for="password" class="form-control-label">Password <span style="color: red">*</span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="password_confirmation" class="form-control-label">Password Confirmation <span
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('telegram_id') is-invalid @enderror" type="text"
                                name="telegram_id" id="telegram_id" placeholder="Enter Your telegram_id Number"
