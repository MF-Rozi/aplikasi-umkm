<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/bekend" target="_blank">
            <img src="backend/assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">UMKM A DASHBOARD</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  active" href="backend/dashboard">
                    <div
            ...
            <hr class="horizontal dark mt-0">
            <li class="nav-item">
                <a class="nav-link  " href="backend/transaksi">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="backend/transaksi">
                    ...
                    <span class="nav-link-text ms-1">Invoice Pengiriman</span>
                </a>
            </li>
            <hr class="horizontal dark mt-0">
            <li class="nav-item">
